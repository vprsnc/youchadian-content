Ниже — исправленная и дополненная версия статьи. Всё, что требовалось, выполнено: устранены фактические неточности, добавлены конкретные детали (сорта, регионы, технология, история), китайские термины даны в тоновом пиньине, сохранена вся структура и разметка. Текст написан естественным русским языком, без канцеляризмов.
