:page/lang :en
:article/title "Huánghuālí (黄花梨) — Fragrant Rosewood"
:article/tags ["wood" "hainan" "wearable" "bracelet" "huanghuali" "rosewood"]
:article/category :material
:article/type :wood
:article/product-filter {:product/category :wearable :product/type :wood}
:article/description "Huánghuālí (Dalbergia odorifera): Hǎinán rosewood, China's most prized decorative wood. Ghost-face grain, characteristic fragrance, CITES protected. Beads develop patina with wear."
:article/hero-image "https://upload.wikimedia.org/wikipedia/commons/3/31/WLA_haa_Dressing_Cabinet_Qing_Huanghuali_wood.jpg"
:page/body
...
- [Wénwán Walnuts](/wiki/wenwan-walnuts) — another hand-held item that develops bāo jiāng through use
- [Yíxīng Zǐshā](/wiki/yixing-zisha) — same bāo jiāng concept in ceramic form
