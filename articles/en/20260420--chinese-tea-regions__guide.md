...
Harvest occurs three times a year: spring, autumn (best for intensity of aroma), and winter (minimal). The roasting stage (bèi huǒ, 焙火) is critical: it fixes the aroma, increases sweetness, and adds smoky tones. → [Dāncōng](/wiki/dancong)
...
Ānhuà was a historic centre on the Tea Horse Route, passing through Húběi and Gānsù to Tibet. → [Hēichá — Dark Tea](/wiki/heicha)
