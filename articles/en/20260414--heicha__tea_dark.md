:page/lang :en
:article/title "Hēichá (黑茶) — Chinese Dark Tea"
:article/tags ["heicha" "dark-tea" "fermented" "puerh" "fu-brick" "liubao" "yunnan" "hunan"]
:article/category :tea
:article/type :dark
:article/description "Hēichá (黑茶): China's six post-fermented teas — pǔ'ěr, Fu brick (Eurotium cristatum/金花), Liu Bao, Liu'an, Tibetan tea, Qingzhuan. Defined by microbial transformation, not heat."
...
- [Pǔ'ěr Overview](/wiki/puerh) — geography, pressing forms, storage
- [Shēng Pǔ'ěr (生茶)](/wiki/puerh-sheng) — raw puerh and aging
- [Shú Pǔ'ěr (熟茶)](/wiki/puerh-shu) — ripe puerh and wòduī
- [Lǎo Bānzhāng](/wiki/laobanzhan) — the most prized puerh terroir
